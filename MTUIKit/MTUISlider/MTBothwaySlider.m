...
#import "MTBothwaySlider.h"

@interface MTBothwaySlider ()

@property (nonatomic, strong) UIView *rangeView;    //非空白区域的视图

@end

@implementation MTBothwaySlider
...
- (void)commonInit {
    ...
    _adsorbInfo = [[MTAdsorbInfo alloc] initWithMin:0 max:0 toValue:0];
 ...
 */
- (void)setAdsorbInfo:(MTAdsorbInfo *)adsorbInfo {
